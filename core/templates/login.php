...
<form method="post" name="login">
	...
	<?php if (!empty($_['redirect_url'])) {
		...
		<div class="login100-form-title" style="background-image: url(http://images.ndh.vn/Images/Uploaded/Store/51/71/76/5171768.jpg);">
					<!-- <span class="login100-form-title-1">
						Hệ thống lưu trữ trực tuyến IT - HUMG
					</span> -->
		</div>

		<!-- <label class="label-input100"><b>Tài Khoản</b></label> -->
		<p class="grouptop">
		...
		<!-- <label class="label-input100"><b>Mật Khẩu</b></label> -->
		<p class="groupbottom">
